...
class satis(Exchange, ImplicitAPI):
    ...
    def cancel_order(self, id: str, symbol: Optional[str] = None, params={}):
        ...
        order = self.privateGetOrder(request)
    ...
    def edit_margin(self, symbol: str, amount: str, params={}):
        self.load_markets()
        market = self.market(symbol)
        request = {
            'product_id': market['id'],
        ...
        response = self.privatePostPositionMargin(
            self.extend(request, params))
        return self.parse_position(response)

    def add_margin(self, symbol: str, amount: str, params={}):
        return self.edit_margin(symbol, amount, params)

    def reduce_margin(self, symbol: str, amount: str, params={}):
